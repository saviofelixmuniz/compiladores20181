...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>exprswitchcase</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.exprswitchcaseImpl#getExpressionlist <em>Expressionlist</em>}</li>
 * </ul>
 *
 * @generated
 */
public class exprswitchcaseImpl extends MinimalEObjectImpl.Container implements exprswitchcase
{
  ...
  {
    return MyDslPackage.Literals.EXPRSWITCHCASE;
  }
  ...
  public NotificationChain basicSetExpressionlist(expressionlist newExpressionlist, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRSWITCHCASE__EXPRESSIONLIST, oldExpressionlist, newExpressionlist);
  ...
  public void setExpressionlist(expressionlist newExpressionlist)
  {
    if (newExpressionlist != expressionlist)
    {
      ...
      if (expressionlist != null)
        msgs = ((InternalEObject)expressionlist).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRSWITCHCASE__EXPRESSIONLIST, null, msgs);
      if (newExpressionlist != null)
        msgs = ((InternalEObject)newExpressionlist).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRSWITCHCASE__EXPRESSIONLIST, null, msgs);
      msgs = basicSetExpressionlist(newExpressionlist, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRSWITCHCASE__EXPRESSIONLIST, newExpressionlist, newExpressionlist));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.EXPRSWITCHCASE__EXPRESSIONLIST:
