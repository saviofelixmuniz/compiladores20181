...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>shortvardecl</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.shortvardeclImpl#getIdentifierlist <em>Identifierlist</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.shortvardeclImpl#getExpressionlist <em>Expressionlist</em>}</li>
 * </ul>
 *
 * @generated
 */
public class shortvardeclImpl extends MinimalEObjectImpl.Container implements shortvardecl
{
  ...
  {
    return MyDslPackage.Literals.SHORTVARDECL;
  }
  ...
  public void setIdentifierlist(String newIdentifierlist)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.SHORTVARDECL__IDENTIFIERLIST, oldIdentifierlist, identifierlist));
  }
  ...
  public NotificationChain basicSetExpressionlist(expressionlist newExpressionlist, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.SHORTVARDECL__EXPRESSIONLIST, oldExpressionlist, newExpressionlist);
  ...
  public void setExpressionlist(expressionlist newExpressionlist)
  {
    if (newExpressionlist != expressionlist)
    {
      ...
      if (expressionlist != null)
        msgs = ((InternalEObject)expressionlist).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.SHORTVARDECL__EXPRESSIONLIST, null, msgs);
      if (newExpressionlist != null)
        msgs = ((InternalEObject)newExpressionlist).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.SHORTVARDECL__EXPRESSIONLIST, null, msgs);
      msgs = basicSetExpressionlist(newExpressionlist, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.SHORTVARDECL__EXPRESSIONLIST, newExpressionlist, newExpressionlist));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.SHORTVARDECL__EXPRESSIONLIST:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.SHORTVARDECL__IDENTIFIERLIST:
