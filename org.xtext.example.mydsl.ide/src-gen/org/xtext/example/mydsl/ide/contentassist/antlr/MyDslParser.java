...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPrimaryexprAccess().getAlternatives_1_1(), "rule__Primaryexpr__Alternatives_1_1");
			builder.put(grammarAccess.getOperandAccess().getAlternatives(), "rule__Operand__Alternatives");
			builder.put(grammarAccess.getTypeAccess().getAlternatives(), "rule__Type__Alternatives");
			builder.put(grammarAccess.getTypeauxAccess().getAlternatives(), "rule__Typeaux__Alternatives");
			builder.put(grammarAccess.getPrimaryexprauxAccess().getAlternatives(), "rule__Primaryexpraux__Alternatives");
			builder.put(grammarAccess.getPrimaryexprauxAccess().getAlternatives_0_1(), "rule__Primaryexpraux__Alternatives_0_1");
			builder.put(grammarAccess.getPrimaryexprauxAccess().getAlternatives_1_1(), "rule__Primaryexpraux__Alternatives_1_1");
			builder.put(grammarAccess.getArgumentsAccess().getAlternatives_2_0(), "rule__Arguments__Alternatives_2_0");
			builder.put(grammarAccess.getSliceAccess().getAlternatives_3(), "rule__Slice__Alternatives_3");
			...
			builder.put(grammarAccess.getSimplestmtAccess().getAlternatives_0_1(), "rule__Simplestmt__Alternatives_0_1");
			...
			builder.put(grammarAccess.getIncdecstmtauxAccess().getAlternatives(), "rule__Incdecstmtaux__Alternatives");
			...
			builder.put(grammarAccess.getTypeauxAccess().getGroup_0(), "rule__Typeaux__Group_0__0");
			...
			builder.put(grammarAccess.getSliceAccess().getGroup_3_0(), "rule__Slice__Group_3_0__0");
			builder.put(grammarAccess.getSliceAccess().getGroup_3_0_0(), "rule__Slice__Group_3_0_0__0");
			...
			builder.put(grammarAccess.getSimplestmtAccess().getGroup_0_1_0(), "rule__Simplestmt__Group_0_1_0__0");
			...
			builder.put(grammarAccess.getSendstmtauxAccess().getGroup(), "rule__Sendstmtaux__Group__0");
			builder.put(grammarAccess.getSendstmtauxAccess().getGroup_0(), "rule__Sendstmtaux__Group_0__0");
			...
			builder.put(grammarAccess.getPostexpressionlistAccess().getGroup(), "rule__Postexpressionlist__Group__0");
			builder.put(grammarAccess.getPostexpressionlistAccess().getGroup_1(), "rule__Postexpressionlist__Group_1__0");
			...
			builder.put(grammarAccess.getForstmtAccess().getGroup_1_1(), "rule__Forstmt__Group_1_1__0");
			...
			builder.put(grammarAccess.getAssignmentauxAccess().getGroup(), "rule__Assignmentaux__Group__0");
			...
			builder.put(grammarAccess.getChanneltypeAccess().getGroup_0_0_0(), "rule__Channeltype__Group_0_0_0__0");
			...
			builder.put(grammarAccess.getPrimaryexprAccess().getTypeAssignment_1_0(), "rule__Primaryexpr__TypeAssignment_1_0");
			builder.put(grammarAccess.getPrimaryexprAccess().getConversionAssignment_1_1_0(), "rule__Primaryexpr__ConversionAssignment_1_1_0");
			builder.put(grammarAccess.getPrimaryexprAccess().getMethodexprAssignment_1_1_1(), "rule__Primaryexpr__MethodexprAssignment_1_1_1");
			builder.put(grammarAccess.getPrimaryexprAccess().getPrimaryexprauxAssignment_1_2(), "rule__Primaryexpr__PrimaryexprauxAssignment_1_2");
			builder.put(grammarAccess.getPrimaryexprAccess().getTypenameAssignment_2_0(), "rule__Primaryexpr__TypenameAssignment_2_0");
			...
			builder.put(grammarAccess.getTypeAccess().getTypelitAssignment_2(), "rule__Type__TypelitAssignment_2");
			builder.put(grammarAccess.getTypeauxAccess().getTypeAssignment_0_1(), "rule__Typeaux__TypeAssignment_0_1");
			builder.put(grammarAccess.getTypeauxAccess().getTypelitAssignment_1(), "rule__Typeaux__TypelitAssignment_1");
			builder.put(grammarAccess.getMethodexprAccess().getMethodnameAssignment_1(), "rule__Methodexpr__MethodnameAssignment_1");
			builder.put(grammarAccess.getConversionAccess().getExpressionAssignment_1(), "rule__Conversion__ExpressionAssignment_1");
			builder.put(grammarAccess.getPrimaryexprauxAccess().getSelectorAssignment_0_1_0(), "rule__Primaryexpraux__SelectorAssignment_0_1_0");
			builder.put(grammarAccess.getPrimaryexprauxAccess().getTypeassertionAssignment_0_1_1(), "rule__Primaryexpraux__TypeassertionAssignment_0_1_1");
			builder.put(grammarAccess.getPrimaryexprauxAccess().getPrimaryexprauxAssignment_0_2(), "rule__Primaryexpraux__PrimaryexprauxAssignment_0_2");
			builder.put(grammarAccess.getPrimaryexprauxAccess().getSliceAssignment_1_1_0(), "rule__Primaryexpraux__SliceAssignment_1_1_0");
			builder.put(grammarAccess.getPrimaryexprauxAccess().getIndexAssignment_1_1_1(), "rule__Primaryexpraux__IndexAssignment_1_1_1");
			builder.put(grammarAccess.getPrimaryexprauxAccess().getPrimaryexprauxAssignment_1_2(), "rule__Primaryexpraux__PrimaryexprauxAssignment_1_2");
			builder.put(grammarAccess.getPrimaryexprauxAccess().getArgumentsAssignment_2_0(), "rule__Primaryexpraux__ArgumentsAssignment_2_0");
			...
			builder.put(grammarAccess.getSliceAccess().getExpressionAssignment_1(), "rule__Slice__ExpressionAssignment_1");
			builder.put(grammarAccess.getSliceAccess().getExpressionAssignment_3_0_0_0(), "rule__Slice__ExpressionAssignment_3_0_0_0");
			builder.put(grammarAccess.getSliceAccess().getExpressionAssignment_3_0_0_2(), "rule__Slice__ExpressionAssignment_3_0_0_2");
			builder.put(grammarAccess.getSliceAccess().getExpressionAssignment_3_1(), "rule__Slice__ExpressionAssignment_3_1");
			...
			builder.put(grammarAccess.getKeyAccess().getExpressionAssignment_0_1(), "rule__Key__ExpressionAssignment_0_1");
			builder.put(grammarAccess.getKeyAccess().getIDENTIFIERAssignment_1(), "rule__Key__IDENTIFIERAssignment_1");
			...
			builder.put(grammarAccess.getStatementAccess().getSimplestmtAssignment_0(), "rule__Statement__SimplestmtAssignment_0");
			builder.put(grammarAccess.getStatementAccess().getDeclarationAssignment_1(), "rule__Statement__DeclarationAssignment_1");
			builder.put(grammarAccess.getStatementAccess().getLabeledstmtAssignment_2(), "rule__Statement__LabeledstmtAssignment_2");
			...
			builder.put(grammarAccess.getSimplestmtAccess().getExpressionAssignment_0_0(), "rule__Simplestmt__ExpressionAssignment_0_0");
			builder.put(grammarAccess.getSimplestmtAccess().getSendstmtAssignment_0_1_0_0(), "rule__Simplestmt__SendstmtAssignment_0_1_0_0");
			builder.put(grammarAccess.getSimplestmtAccess().getIncdecstmtAssignment_0_1_1(), "rule__Simplestmt__IncdecstmtAssignment_0_1_1");
			builder.put(grammarAccess.getSimplestmtAccess().getAssignmentAssignment_0_1_2(), "rule__Simplestmt__AssignmentAssignment_0_1_2");
			builder.put(grammarAccess.getSimplestmtAccess().getShortvardeclAssignment_1(), "rule__Simplestmt__ShortvardeclAssignment_1");
			...
			builder.put(grammarAccess.getSendstmtauxAccess().getExpressionAssignment_0_1(), "rule__Sendstmtaux__ExpressionAssignment_0_1");
			...
			builder.put(grammarAccess.getPostexpressionlistAccess().getExpressionAssignment_1_1(), "rule__Postexpressionlist__ExpressionAssignment_1_1");
			builder.put(grammarAccess.getForstmtAccess().getRangeclauseAssignment_1_1_1(), "rule__Forstmt__RangeclauseAssignment_1_1_1");
			...
			builder.put(grammarAccess.getForclauseAccess().getSimplestmtAssignment_1(), "rule__Forclause__SimplestmtAssignment_1");
			builder.put(grammarAccess.getForclauseAccess().getExpressionAssignment_3(), "rule__Forclause__ExpressionAssignment_3");
			builder.put(grammarAccess.getForclauseAccess().getSimplestmtAssignment_5(), "rule__Forclause__SimplestmtAssignment_5");
			...
			builder.put(grammarAccess.getAssignmentauxAccess().getPostexpressionlistAssignment_0(), "rule__Assignmentaux__PostexpressionlistAssignment_0");
			builder.put(grammarAccess.getAssignmentauxAccess().getASSIGN_OPAssignment_1(), "rule__Assignmentaux__ASSIGN_OPAssignment_1");
			builder.put(grammarAccess.getAssignmentauxAccess().getExpressionlistAssignment_2(), "rule__Assignmentaux__ExpressionlistAssignment_2");
